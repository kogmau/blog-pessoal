...
import com.generation.blogpessoal.blog.model.TemaModel;
import com.generation.blogpessoal.repositorio.TemaRepository;
...
public class TemaController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<TemaModel> getByIdEntity(@PathVariable long id){
